...
{
	public class FormsApplicationPage : WpfApplicationPage
	{
		...
		protected FormsApplicationPage()
		{
			...
			MessagingCenter.Send(this, Forms.WP8DeviceInfo.BWPorientationChangedName, DeviceOrientation.Landscape);
