...
namespace Xamarin.Forms.Platform.WPF
{
	...
	public class FormsPhoneTextBox : PhoneTextBox
	{
		...
		void UpdateInputScope()
		{
			...
			//if (IsPassword)
			//{
			//	_cachedInputScope = System.Windows.Input.InputScope;
			//	System.Windows.Input.InputScope = PasswordInputScope; // We don't want suggestions turned on if we're in password mode
			//}
			//else
			//	System.Windows.Input.InputScope = _cachedInputScope;
		}
	}
}